...
# install mongodb
RUN sudo apt-get update && sudo apt-key adv --keyserver hkp://keyserver.ubuntu.com:80 --recv EA312927
...
RUN sudo sudo apt-get update && sudo apt-get install -y mongodb-org
